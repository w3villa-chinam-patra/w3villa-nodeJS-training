  ...
  return (
    <div className="wrapper bg-neutral-100">
      <div className="container mx-auto p-6 flex justify-between items-center">
        ...
        {user || userInContext ? (
          <div className="flex gap-3 border border-teal-200 bg-teal-100/40 p-1 pr-2 rounded-full items-center">
            <FaUser className="text-5xl bg-white border border-gray-200 p-1 rounded-full" />
          ...
          <ul className="buttons flex items-center text-lg gap-4">
            <Link
              ...
              className="cursor-pointer px-6 py-2 bg-teal-500 text-white rounded-full"
            >
              Login
            </Link>
            <Link
